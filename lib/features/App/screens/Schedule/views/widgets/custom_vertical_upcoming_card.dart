...
class CustomVerticalUpcomingCard extends StatelessWidget {
  const CustomVerticalUpcomingCard({super.key});
  @override
          ...
          children: [
            ListTile(
              ...
              leading: const CircleAvatar(
                radius: 25,
                backgroundImage: AssetImage(TImages.doctorImage2),
              ),
            ),
            const Padding(
